package com.example.gd13_d_0824
...
class AddEditActivityTest {
    ...
    fun addEditActivityTest() {
        ...
        textInputEditText.perform(scrollTo(), replaceText("calvin"), closeSoftKeyboard())
        ...
        textInputEditText2.perform(scrollTo(), replaceText("200710824"), closeSoftKeyboard())
            ...
            allOf(
                ...
                childAtPosition(
                    allOf(
                        withId(R.id.ll_button),
                        childAtPosition(
                            withClassName(`is`("androidx.constraintlayout.widgeet.ConstraintLayout")),
                            1
                        )
                    ),
                    1
